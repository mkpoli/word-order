...
const createLL = () => ({
	...
	params: {
		...
		dottedEndRadius: m.params_dotted_end_radius,
		...
		alignLeft: m.params_align_left,
		alignCenter: m.params_align_center,
		alignRight: m.params_align_right,
	...
	menu: {
		...
		qr: m.menu_qr,
		qrTitle: m.menu_qr_title,
		qrClose: m.menu_qr_close,
		qrLinkLabel: m.menu_qr_link_label,
		qrDownloadSvg: m.menu_qr_download_svg,
		qrDownloadPng: m.menu_qr_download_png,
		qrTooLong: m.menu_qr_too_long,
		svg: m.menu_svg,
		png: m.menu_png,
		pdf: m.menu_pdf,
		...
		copyImage: m.menu_copy_image,
		copyImageBusy: m.menu_copy_image_busy,
